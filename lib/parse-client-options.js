...
function parseOptions (userOptions) {
  ...
  if (userOptions.customHttpClient) {
    // clientDefaults.request.client = userOptions.customHttpClient;
    if (userOptions.customClientOptions) {
      clientDefaults.request.customClientOptions = userOptions.customClientOptions;
    }
  }
